...
function drawXAxisTickLabel(value, layout, mapFunction) 
{
  ...
  // Start
  // This is for happiest-countries.js  
  let pause = false; // Boolean to control the start/stop of bubbles

  // function to pause the bubbles when mouse is pressed
